...
public class CurrencyConversionV1
{
    public static void main(String [ ] args)
    {
        ...
        double pesoExchangeRage = 16.57731;         // local variable for exchange rate of US Dollars to Pesos
        ...
        double yenExchangeRate = 120.0120;          // local variable for exchange rate of US dollars to yen
        ...
        double euroExchangeRate = 0.888334;         // local variable for exchange rate of US dollars to euros
