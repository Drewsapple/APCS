...
public class Magpie2 extends MagpieRunner2
{
	...
	public String getResponse(String statement)
	{
		...
		else if (findKeyword(statement,"Mr. Shelton") >= 0)
		{
		...
		else if(findKeyword(statement,"random") >= 0)
		{
			response = "Here is a random number between 0 and 1: "+Math.random();
		}
